> This is the README of [MadLlama25/fastmail-mcp](https://github.com/MadLlama25/fastmail-mcp) at the last merged upstream commit, kept word for word so nothing is lost. The fork's own README is [../README.md](../README.md). Setup, CalDAV, WebDAV, attachments on send, contacts scope and troubleshooting below still apply as written.
